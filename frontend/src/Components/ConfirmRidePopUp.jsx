...
const ConfirmRidePopUp  = (props) => {
     ...
     const navigate = useNavigate();
           const SubmitHandler = async (e) => {
             e.preventDefault();
             try {
               await axios.get(`${import.meta.env.VITE_BASE_URL}/start-ride`, {
                params: {
                  otp: OTP,
  ...
  return (
    <div className="bg-gray-100 w-full h-screen ">
      <h3
        onClick={() => props.setConfirmRidePopUpPanal(false)}
      ...
      <div className="flex justify-between gap-3 items-center mt-5 p-2 bg-gradient-to-b from-gray-100 to-gray-200 rounded ">
        <div className="flex justify-between items-center gap-5">
          <img
            ...
            alt=""
          />
          <h4 className="font-semibold text-xl ">{props.ride?.fullname?.firstname}</h4>
        </div>
