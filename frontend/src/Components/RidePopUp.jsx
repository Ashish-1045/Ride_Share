  ...
  return (
    <div className="bg-gray-100 w-full">
      ...
      {/* <div className=" w-full flex items-center justify-center rounded-lg mb-4">
            <img className="h-35 object-cover   " src="" alt="Car" />
          </div> */}
      ...
      <button
        ...
        className="bg-orange-400 text-black py-3 px-26 rounded-lg text-xl font-semibold hover:bg-green-600 transition duration-300 w-full mt-4"
      >
        Accept
      </button>
      <button
        ...
        className="bg-gray-400 text-black py-3 px-26 rounded-lg text-xl font-semibold hover:bg-gray-700 transition duration-300 w-full mt-4"
      >
        Ignore
      </button>
    </div>
