  ...
  return (
    <div className="w-full h-screen  flex flex-col overflow-hidden">
      ...
      <div className="w-full h-2/5  p-2">
        <div className="w-full flex justify-between items-center rounded-lg mt-4  ">
          <div className="flex justify-start gap-3 items-center">
            <img
              ...
              alt=""
            />
            <h4 className="font-semibold text-xl ">Johns Boy</h4>
          </div>
          <div>
            <h5 className="text-lg font-medium">₹296.50</h5>
            <button className="text-zinc-600">Earned </button>
          </div>
        </div>
        <div className="flex justify-between items-center  text-center mt-5 bg-gradient-to-b from-gray-100 to-gray-200 rounded-xl p-3">
          <div >
            <i className="text-2xl font-bold ri-time-line"></i>
            <h4 className="text-xl font-medium">$ 102.2</h4>
            <p className="text-sm text-gray-600 ">BE ON TIME</p>
          </div>
          <div >
            <i className="text-2xl font-bold ri-speed-up-fill"></i>
            <h4 className="text-xl font-medium">$ 102.2</h4>
            <p className="text-sm text-gray-600 ">BE ON TIME</p>
          </div>
          <div >
            <i className="text-2xl font-bold ri-booklet-line"></i>
            <h4 className="text-xl font-medium">$ 102.2</h4>
            <p className="text-sm text-gray-600 ">BE ON TIME</p>
          </div>
        </div>
